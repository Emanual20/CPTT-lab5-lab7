    ...
    switch(this->optype){
        ...
        case OP_EQ:{
            ...
            if(ptr_lvalparam->nodeType == NODE_VAR){
                ...
                ptr_lvalparam->gen_array_store_code(asmo,ptr_lvalparam);
            }
...
void TreeNode::gen_array_code(ostream &asmo,TreeNode* t){
...
void TreeNode::gen_array_store_code(ostream &asmo,TreeNode* t){
